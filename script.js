document.addEventListener('DOMContentLoaded', () => {
    ...
    function initialize() {
        ...
        initializeThoughtProcessDisplays();
    }
    ...
    function clearCollaboration() {
        ...
        failedModels = {};
        latestResult = "";
        for (const workerKey in workers) workers[workerKey].thoughtProcess = [];
...
5. Include your specific perspective based on your assigned role.`;
    ...
    function analyzeThoughtProcess(worker, response) {
        ...
        if (worker.thoughtProcess.length > maxThoughts) worker.thoughtProcess.shift();
    }
